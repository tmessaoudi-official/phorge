...
Phorge's editor integration is **one language server + one grammar**, reused by every editor — so
...
- **Grammar:** `vscode/syntaxes/phorge.tmLanguage.json` — a TextMate grammar (keywords, types, strings
